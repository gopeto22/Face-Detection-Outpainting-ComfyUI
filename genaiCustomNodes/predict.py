...
class Predictor(cog.Predictor):
    def setup(self):
        ...
        self.yunet_model = GENAI_LoadYuNetModel().run("/path/to/your/yunet_model.onnx")[0]
    ...
    def predict(self, image, HR=False, with_scratch=False):
        try:
            ...
            # Stage 2: Face Detection using custom node
            ...
            for img_file in os.listdir(stage_2_input_dir):
                ...
                face_detections = GENAI_DetectFacesYuNet().run(self.yunet_model, img, 1.0)[0]
                img_with_landmarks, bounding_boxes = GENAI_VisualizeYuNetLandmarks().run(img, face_detections, 2)
